...
public class EvenementChangementDeplacementAscenseur extends PrintableEvenement
{
    ...
    public EvenementChangementDeplacementAscenseur(long time,int ascId,long oldDepTime, float oldXi, float oldVi, float oldGamma, float newXi, float newVi, float newG,boolean executerTasks)
    {
