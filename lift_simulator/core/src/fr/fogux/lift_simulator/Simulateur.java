...
public class Simulateur extends Game {
	...
	public void startSimulation(File dossier,boolean playAnimation)
	{
	    String activePrgmName = ProgrammeEntryListener.getActiveProgramName();
	...
	protected void doSimulation(File dossier,String activePrgmName)
	{
	...
	public static void setImmeubleVisu(ImmeubleVisu visu)
	{
	    immeubleVisu = visu;
	}
	...
	public void startVisualisation(File file)
	{
	...
	protected void doVisualisation()
	{
	    ...
	    gestioSimu = null;
	    GestionnaireDeTachesVisu ges = new GestionnaireDeTachesVisu();
