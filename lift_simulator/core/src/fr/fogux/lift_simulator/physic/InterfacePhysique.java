 ...
 * @author Florent
 *
 * seules ces méthodes statiques doivent être appelées par le Programme en lui même
 */
public class InterfacePhysique
{
    ...
    /**
     * permet d'entammer un déplacement linéaire de l'ascenseur.
     * la méthode peut provoquer une erreur si l'ascenseur n'est pas en état
     * de se déplacer.
     * 
    ...
    /**
     * allume/éteint un bouton parmis les boutons présents dans les etages, 
     * un bouton allumé aura pour effet de dissuader les personnes d'appuyer a nouveau dessus
     * @param niveau auquel se trouve le bouton
     * @param on true le bouton doit être allumé
     * @param haut true si l'action doit être effectuée sur le bouton du haut, false: bas
     */
    ...
    /**
     * 
     * allume/éteint un bouton parmis les boutons présents dans les ascenseurs, 
     * un bouton allumé aura pour effet de dissuader les personnes d'appuyer a nouveau dessus
    ...
    /**
     * ouvre les portes d'un ascenseur pour permettre aux personnes en attente d'entrer.
     * la méthode peut provoquer une erreur si l'état de l'immeuble n'est pas compatible avec
