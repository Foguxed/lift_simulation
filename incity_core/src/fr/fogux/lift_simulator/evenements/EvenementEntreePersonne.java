...
public class EvenementEntreePersonne extends AnimatedEvent
{
    ...
    {
        super.simuRun();
        PersonneSimu.getPersonne(personneId).entrerDansAscenseur(Simulateur.getImmeubleSimu().
                getAscenseur(ascenseurId));
    }
    ...
    protected void runAnimation(long timeDebut,long animationDuree)
    {
        ...
        timeDebut,animationDuree,
        Simulateur.getImmeubleVisu().getEtage(niveau),
