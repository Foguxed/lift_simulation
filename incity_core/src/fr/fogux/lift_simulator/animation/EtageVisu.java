...
public class EtageVisu extends Etage implements PredictedDrawable,ReferencePosUsers,PersonneGroupContainer
{
    ...
    protected void updateGroupsPos()
    {
        ...
        {
            Vector2 vec = new Vector2(xMaxAttente-(listGroupes.size()-1-i)*nouvelEcart,drawableObject.getY()+20);
    ...
    {
        System.out.println("update evenement debut arrivee " + String.valueOf(System.currentTimeMillis() - GameScreen.realTimeUpdate));
        ...
        System.out.println("update evenement fin arrivee " + String.valueOf(System.currentTimeMillis() - GameScreen.realTimeUpdate));
        updateGroupsPos();
    }
