...
public class TagNames
{
    ...
    public static final String ascenseurId = "ascId";
    ...
    public static final String etageMin = "etageMin";
    public static final String etageMax = "etageMax";
    public static final String nbAscenseurs = "nbAscenseurs";
    ...
    public static final String capacitePersonnes = "capacitePersonnes";
    public static final String vitesse = "vitesse";
    public static final String tempsOuverturePortes = "tempsOuverturePortes";
